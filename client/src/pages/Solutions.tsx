  ...
  return (
    <div className="min-h-screen bg-background">
      <SEO 
        ...
        description="Tailored AI communication solutions for single hotels, hotel chains, and hostels. Streamline operations and enhance guest experience across your property."
        ...
        <div className="container mx-auto px-4">
          ...
          <Tabs defaultValue="chain" className="max-w-5xl mx-auto">
            <TabsList className="grid w-full grid-cols-2 mb-12 gap-4">
              <TabsTrigger value="chain" className="gap-2 border-2 border-solid border-primary/30 rounded-lg data-[state=active]:border-primary data-[state=active]:bg-gradient-to-br data-[state=active]:from-primary/10 data-[state=active]:to-primary/5 data-[state=active]:shadow-md transition-all duration-200" data-testid="tab-hotel-chain">
                <Network className="w-4 h-4" />
                {t("solutions.tab.chain")}
              </TabsTrigger>
              <TabsTrigger value="single" className="gap-2 border-2 border-solid border-primary/30 rounded-lg data-[state=active]:border-primary data-[state=active]:bg-gradient-to-br data-[state=active]:from-primary/10 data-[state=active]:to-primary/5 data-[state=active]:shadow-md transition-all duration-200" data-testid="tab-single-hotel">
              ...
              <div className="grid lg:grid-cols-2 gap-12 items-center">
                <div>
                  ...
                  <Button 
                    ...
                    data-testid="button-demo-single"
                  >
